      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="animate-slide-up">
            <p className="text-lg text-gray-200 leading-relaxed mb-8 font-satoshi">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => <div key={feature.title} className="bg-white/10 backdrop-blur-md p-6 rounded-lg border border-blue-500/30 hover:bg-white/20 hover:border-blue-400/60 transition-all duration-300 hover:scale-105 animate-slide-up group" style={{
          animationDelay: `${index * 0.1}s`
              ...
              <h3 className="text-lg font-semibold mb-3 text-white font-satoshi">
                {feature.title}
              </h3>
              
              <p className="text-gray-200 text-sm leading-relaxed font-satoshi">
                {feature.description}
              </p>
            </div>)}
        </div>
