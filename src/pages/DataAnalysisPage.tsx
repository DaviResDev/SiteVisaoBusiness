        ...
        <main className="pt-28 sm:pt-32 pb-16">
          ...
          <section className="py-16 sm:py-20">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center animate-fade-in">
                <h1 className="text-2xl sm:text-6xl md:text-7xl font-bold mb-5 sm:mb-8 font-satoshi leading-tight">
                ...
                <div className="max-w-4xl mx-auto mb-10 sm:mb-12">
                  <p className="text-base sm:text-2xl md:text-3xl text-gray-200 mb-5 sm:mb-8 leading-relaxed font-satoshi">
                    Imagine tomar decisões com <span className="text-blue-400">100% de certeza</span> baseado em dados reais...
                  </p>
                  
                  <p className="text-sm sm:text-xl text-gray-300 leading-relaxed font-satoshi">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 justify-center">
                  <button 
                    ...
                    className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-5 sm:px-8 py-2 sm:py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 inline-flex items-center shadow-lg hover:shadow-blue-500/30 hover:scale-105 font-satoshi text-xs sm:text-base"
                  >
                  ...
                  <button 
                    onClick={handleWhatsAppClick}
                    className="border-2 border-blue-400 text-blue-400 px-5 sm:px-8 py-2 sm:py-4 rounded-lg font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300 shadow-lg hover:scale-105 font-satoshi text-xs sm:text-base"
                  >
          ...
          <section className="py-20 sm:py-32">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16 animate-fade-in">
                <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-5 sm:mb-6 font-satoshi">
              ...
              <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 animate-slide-up">
                <div className="bg-gradient-to-br from-red-900/40 to-black/60 backdrop-blur-md border border-red-400/30 rounded-2xl p-6 sm:p-8 shadow-2xl">
                  <Eye className="w-12 h-12 sm:w-16 sm:h-16 text-red-400 mx-auto mb-4 sm:mb-6" />
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 font-satoshi">
                    Decisões baseadas em "achismo"
                  </h3>
                  <p className="text-gray-300 text-sm sm:text-lg leading-relaxed font-satoshi">
                ...
                <div className="bg-gradient-to-br from-red-900/40 to-black/60 backdrop-blur-md border border-red-400/30 rounded-2xl p-6 sm:p-8 shadow-2xl">
                  <TrendingUp className="w-12 h-12 sm:w-16 sm:h-16 text-red-400 mx-auto mb-4 sm:mb-6" />
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 font-satoshi">
          ...
          <section className="py-16 sm:py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="bg-gradient-to-br from-blue-900/20 to-black/40 backdrop-blur-md border border-blue-400/30 rounded-2xl p-8 sm:p-12 animate-fade-in shadow-2xl">
                <div className="text-center mb-8">
                  <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6 font-satoshi">
                    Dashboard Interativo - Power BI
                  </h3>
                  <p className="text-gray-200 text-sm sm:text-lg leading-relaxed font-satoshi">
          ...
          <section className="py-20 sm:py-32">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 animate-slide-up">
                <div className="bg-gradient-to-br from-green-900/40 to-black/60 backdrop-blur-md border border-green-400/30 rounded-2xl p-6 sm:p-8 shadow-2xl">
                  <Brain className="w-12 h-12 sm:w-16 sm:h-16 text-green-400 mx-auto mb-4 sm:mb-6" />
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 font-satoshi">
                ...
                <div className="bg-gradient-to-br from-green-900/40 to-black/60 backdrop-blur-md border border-green-400/30 rounded-2xl p-6 sm:p-8 shadow-2xl">
                  <Target className="w-12 h-12 sm:w-16 sm:h-16 text-green-400 mx-auto mb-4 sm:mb-6" />
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 font-satoshi">
                ...
                <div className="bg-gradient-to-br from-green-900/40 to-black/60 backdrop-blur-md border border-green-400/30 rounded-2xl p-6 sm:p-8 shadow-2xl">
                  <Zap className="w-12 h-12 sm:w-16 sm:h-16 text-green-400 mx-auto mb-4 sm:mb-6" />
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 font-satoshi">
          ...
          <section className="py-20 sm:py-32">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-blue-900/20 to-black/40 backdrop-blur-xl border border-blue-400/30 rounded-2xl p-10 sm:p-16 text-center animate-fade-in shadow-2xl">
                  <div className="relative z-10">
                    ...
                    <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 text-base sm:text-lg leading-relaxed">
                      <p className="text-gray-200 font-satoshi text-base sm:text-xl">
                      ...
                      <div className="pt-8">
                        ...
                        <p className="text-base sm:text-xl text-gray-200 font-satoshi">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-16">
                <div className="bg-gradient-to-br from-blue-900/40 to-black/60 backdrop-blur-md border border-blue-400/30 rounded-2xl p-8 text-center animate-slide-up shadow-2xl">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-500/20 rounded-lg flex items-center justify-center text-blue-400 mx-auto mb-4 sm:mb-6">
                    <Star className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>
                  <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 font-satoshi">97%</h3>
                ...
                <div className="bg-gradient-to-br from-blue-900/40 to-black/60 backdrop-blur-md border border-blue-400/30 rounded-2xl p-8 text-center animate-slide-up shadow-2xl">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 font-satoshi">400%</h3>
                ...
                <div className="bg-gradient-to-br from-blue-900/40 to-black/60 backdrop-blur-md border border-blue-400/30 rounded-2xl p-8 text-center animate-slide-up shadow-2xl">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 font-satoshi">24/7</h3>
                  <p className="text-gray-300 font-satoshi">Monitoramento em tempo real</p>
                </div>
              </div>

              <div className="text-center animate-fade-in">
                <p className="text-lg sm:text-2xl text-red-400 font-semibold mb-3 sm:mb-4 font-satoshi">
                  ⚠️ Cada dia sem dados é uma oportunidade perdida
                </p>
                <p className="text-base sm:text-lg text-gray-300 mb-6 sm:mb-8 font-satoshi">
          ...
          <section className="py-16 sm:py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="bg-gradient-to-r from-blue-600/20 to-blue-800/20 backdrop-blur-md border border-blue-500/30 rounded-2xl p-12 shadow-2xl animate-fade-in">
                <h2 className="text-3xl sm:text-4xl font-bold text-white mb-5 sm:mb-6 font-satoshi">
                  Transforme Dados em Vantagem Competitiva
                </h2>
                <p className="text-base sm:text-xl text-gray-300 mb-6 sm:mb-8 font-satoshi">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                  <button 
                    onClick={handleWhatsAppClick}
                    className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-blue-500/30 hover:scale-105 font-satoshi text-sm sm:text-base"
                  >
                    Quero Meus Dashboards Agora
                  </button>
                  <button 
                    onClick={handleWhatsAppClick}
                    className="border-2 border-blue-400 text-blue-400 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300 shadow-lg hover:scale-105 font-satoshi text-sm sm:text-base"
                  >
