...
const RocketMailHero = () => {
  ...
  return (
    <section className="py-14 sm:py-20 scroll-animation opacity-0 translate-y-10 transition-all duration-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left content */}
          <div>
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-6 sm:mb-8 font-satoshi leading-tight">
              <span className="text-blue-400">Rocket</span>
              <span className="text-white">Mail</span>
            </h1>
            
            <h2 className="text-xl sm:text-2xl md:text-3xl text-gray-200 mb-4 sm:mb-6 font-satoshi">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button 
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 inline-flex items-center justify-center shadow-lg hover:shadow-blue-500/30 hover:scale-105 font-satoshi text-sm sm:text-base"
              >
