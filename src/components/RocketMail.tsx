...
const RocketMail = () => {
  ...
  return <section id="rocket-mail" className="py-12 sm:py-20 relative overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-16 animate-fade-in">
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 font-satoshi">
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 items-center mb-8 sm:mb-16">
          ...
          <div className="animate-slide-up">
            ...
            <h3 className="text-lg sm:text-2xl font-bold text-blue-400 mb-4 sm:mb-6 font-satoshi">Benefícios:</h3>
            ...
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              {benefits.map((benefit, index) => <div key={index} className="flex items-start gap-2 sm:gap-3">
                  ...
                  <p className="text-xs sm:text-base text-gray-200 font-satoshi">{benefit}</p>
                </div>)}
            </div>
          </div>
        </div>

         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 mb-8 sm:mb-16">
          {features.map((feature, index) => <div key={feature.title} className="bg-transparent border border-blue-400/30 p-4 sm:p-6 rounded-lg hover:bg-blue-400/5 hover:border-blue-400/60 transition-all duration-300 hover:scale-105 animate-slide-up group" style={{
          animationDelay: `${index * 0.1}s`
              ...
              <h3 className="text-sm sm:text-lg font-semibold mb-2 sm:mb-3 text-white font-satoshi">
                {feature.title}
              </h3>
              
              <p className="text-xs sm:text-sm text-gray-200 leading-relaxed font-satoshi">
                {feature.description}
              </p>
            </div>)}
        </div>
