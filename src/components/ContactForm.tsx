    ...
    <section className="py-20 scroll-animation">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <h2 className="text-4xl font-bold text-white mb-6">Entre em contato conosco</h2>
            <p className="text-xl text-gray-400 mb-8">
              Pronto para transformar seu negócio? <span className="text-white">Vamos conversar!</span>
            </p>
          ...
          {/* Formulário */}
          <div className="border border-blue-900/30 rounded-2xl p-10 shadow-xl backdrop-blur-md">
