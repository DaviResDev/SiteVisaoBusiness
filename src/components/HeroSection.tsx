      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left animate-fade-in relative">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-satoshi font-bold leading-tight mb-8">
            ...
            <p className="text-xl md:text-2xl text-gray-100 mb-12 leading-relaxed max-w-xl font-satoshi">
