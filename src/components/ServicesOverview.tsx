        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 group-hover:text-blue-300 transition-colors duration-300 min-h-[3rem] sm:min-h-[3.5rem] flex items-center">
                {service.title}
              </h3>
              
              <p className="text-gray-300 mb-4 sm:mb-6 leading-relaxed flex-grow min-h-[4rem] sm:min-h-[4.5rem] text-sm sm:text-base">
                {service.description}
              </p>
